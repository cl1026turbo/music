...
$(function(){
  ...
  //     $(`<link rel="stylesheet" href="css/header.css">`).appendTo("head");
      ...
      if(n){
        //登录成功
      var str=`<a href="#" data-action='login'><img src="img/index/2.jpg"></a>
        <i class="arr"></i>
        <ul>
          <li><i class='mb_icon'></i><a href="login.html">我的主页</a></li>
          <li><i class="wx_icon"></i><a href="javascript:;">我的消息</a></li>
          <li><i class="qq_icon"></i><a href="javascript:;">我的等级</a></li>
          <li><i class="wb_icon"></i><a href="javascript:;">VIP会员</a></li>
          <li><i class="wy_icon"></i><a href="javascript:;">个人设置</a></li>
          <li><i class="wy_icon"></i><a href="javascript:;">实名认证</a></li>
          <li><i class="wy_icon"></i><a href="logout.html">退出</a></li>
          </ul>`
        //获取显示元素
